            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center title-2 mb-3">Edit Jadwal Petugas</h3>
                    </div>
                    <hr>
                    <form method="post" action="{{route('ministry_schedules.update', $ministrySchedule->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12">
                                <select name="choir_id" id="choir_id" class="form-control @error('choir_id') is-invalid @enderror">
                                    ...
                                    <option value="{{$choir->id}}"
                                        @if ($choir->id == $ministrySchedule->choir_id)
                                            selected
                                        @endif>
                                        {{$choir->name}}
                                    </option>
